...
lv_obj_t * ui_ResultsBarScreen = NULL;
lv_obj_t * ui_chartResults = NULL;
lv_obj_t * ui_lblElectionResults = NULL;
lv_obj_t * ui_panelBarChartLabel = NULL;
lv_obj_t * ui_lblBarParty1 = NULL;
lv_obj_t * ui_lblBarParty2 = NULL;
lv_obj_t * ui_lblBarParty3 = NULL;
lv_obj_t * ui_lblBarParty4 = NULL;
lv_obj_t * ui_lblBarParty5 = NULL;
lv_obj_t * ui_lblBarParty6 = NULL;
lv_obj_t * ui_lblBarParty7 = NULL;
// event funtions
...
void ui_ResultsBarScreen_screen_destroy(void)
{
    if(ui_ResultsBarScreen) lv_obj_del(ui_ResultsBarScreen);

    // NULL screen variables
    ui_ResultsBarScreen = NULL;
    ui_chartResults = NULL;
    ui_lblElectionResults = NULL;
    ui_panelBarChartLabel = NULL;
    ui_lblBarParty1 = NULL;
    ui_lblBarParty2 = NULL;
    ui_lblBarParty3 = NULL;
    ui_lblBarParty4 = NULL;
    ui_lblBarParty5 = NULL;
    ui_lblBarParty6 = NULL;
    ui_lblBarParty7 = NULL;
