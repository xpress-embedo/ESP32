...
static dht11_sensor_t dht11_crc_error( void );
...
static dht11_sensor_t dht11_timeout_error()
{
  dht11_sensor_t timeout_error = { DHT11_TIMEOUT_ERROR, -1, -1 };
  return timeout_error;
}

static dht11_sensor_t dht11_crc_error()
{
  dht11_sensor_t crc_error = { DHT11_CHECKSUM_ERROR, -1, -1 };
  return crc_error;
}
