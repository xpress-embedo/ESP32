...
/* Targets: any */
extern lv_font_t * title_large;
extern lv_font_t * body_medium;
extern lv_font_t * body_normal;
...
/* Targets: any */
extern const void * thermometer_img;
extern const void * humidity_img;
extern const void * pressure_img;

/*----------------
 * Subjects
 *----------------*/

extern lv_subject_t red_val;
extern lv_subject_t green_val;
extern lv_subject_t blue_val;
extern lv_subject_t temp_str;
extern lv_subject_t temp_status_str;
extern lv_subject_t hum_str;
extern lv_subject_t hum_status_str;
extern lv_subject_t press_str;
extern lv_subject_t press_status_str;
...
#include "components/sensor_card_gen.h"
#include "screens/main_screen_gen.h"
#include "screens/sensor_screen_gen.h"
